...
const Forms = () => {
  ...
  return (
    <div
      className={`flex flex-col md:flex-row max-w-6xl mx-auto p-6 ${
        !showSuccessIcon && "xl:shadow-lg"
      } rounded-lg gap-x-6 bg-gray-50 relative`}
    >
      {showSuccessIcon ? (
        ...
        <div className="flex flex-col md:flex-row w-full items-center justify-center gap-6">
          <div className="md:flex md:w-1/3 lg:w-1/3 bg-blue-100 p-4 items-center justify-center rounded-lg  h-full">
            <Image
              src="/file.png"
              width={600}
              height={600}
          ...
          <div className="md:w-1/3 lg:w-2/3 w-full px-4 relative">
                ...
                >
                  ...
                  {examCentres.map((centre) => (
                    <option key={centre._id} value={centre.place}>
                      ...
                      {new Date(centre.examTime).toLocaleTimeString([], {
                        hour: "2-digit",
                        minute: "2-digit",
                        hour12: true,
                      })}{" "}
